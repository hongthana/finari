...
const en = {
  ...
  waitlist: {
    ...
    alertSubtitle: "Create and update notification rules (delivery engine coming next).",
    ...
    alertSaved: "Alert saved. Engine delivery is not yet enabled.",
    alertUpdated: "Alert updated. Engine delivery is not yet enabled.",
...
const th: Dictionary = {
  ...
  waitlist: {
    ...
    alertSubtitle:
      "สร้าง/อัปเดตกฎแจ้งเตือน (ระบบส่งสัญญาณยังอยู่ในแผนอนาคต)",
    ...
    alertSaved: "บันทึก alert แล้ว ระบบแจ้งเตือนยังไม่เปิดใช้งาน",
    alertUpdated: "อัปเดต alert แล้ว ระบบแจ้งเตือนยังไม่เปิดใช้งาน",
