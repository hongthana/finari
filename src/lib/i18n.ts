...
const en = {
  ...
  waitlist: {
    ...
    signIn: "Sign in",
    signInEmailTitle: "Sign in with your email",
    signInEmailHelp:
      "Enter your email and Finari will send a secure magic link for this browser.",
    signInSend: "Send link",
    signInSending: "Sending...",
    signInSent: "Check your email for the Finari sign-in link.",
    signInFailed: "Unable to send a sign-in link. Check the email and try again.",
    ...
    alertConditionOptions: {
      ...
      below: "Falls below threshold",
      "change-above": "Increases by more than threshold",
      "change-below": "Drops by more than threshold",
      "above-or-equal": "At or above threshold",
      "below-or-equal": "At or below threshold",
    },
...
const th: Dictionary = {
  ...
  waitlist: {
    ...
    signIn: "เข้าสู่ระบบ",
    signInEmailTitle: "เข้าสู่ระบบด้วยอีเมล",
    signInEmailHelp:
      "กรอกอีเมล แล้ว Finari จะส่ง magic link ที่ปลอดภัยสำหรับเบราว์เซอร์นี้",
    signInSend: "ส่งลิงก์",
    signInSending: "กำลังส่ง...",
    signInSent: "ตรวจอีเมลของคุณเพื่อเปิดลิงก์เข้าสู่ระบบ Finari",
    signInFailed: "ยังส่งลิงก์เข้าสู่ระบบไม่ได้ กรุณาตรวจอีเมลแล้วลองอีกครั้ง",
    ...
    alertTypeOptions: {
      revenue: "รายได้ / ยอดขาย",
      "net-income": "กำไรสุทธิ",
      fcf: "กระแสเงินสดอิสระ (FCF)",
      cash: "เงินสดในงบดุล",
      debt: "หนี้สินรวม",
      "working-capital": "เงินทุนหมุนเวียน",
      "debt-to-equity": "อัตราหนี้ต่อทุน",
      roe: "ผลตอบแทนต่อส่วนผู้ถือหุ้น (ROE)",
      custom: "ตัวชี้วัดกำหนดเอง",
    },
    alertConditionOptions: {
      above: "สูงกว่าค่าที่ตั้งไว้",
      below: "ต่ำกว่าค่าที่ตั้งไว้",
      "change-above": "เพิ่มขึ้นมากกว่าค่าที่ตั้งไว้",
      "change-below": "ลดลงมากกว่าค่าที่ตั้งไว้",
      "above-or-equal": "มากกว่าหรือเท่ากับค่าที่ตั้งไว้",
      "below-or-equal": "น้อยกว่าหรือเท่ากับค่าที่ตั้งไว้",
    },
